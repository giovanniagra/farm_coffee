"""
Django settings for farm_coffee project.
...
SECRET_KEY = 'django-insecure-=yixc^v)u1h!u+d(i+sy*-#8#ffmi99!gctseyp53t=c6fzpc5'
...
WSGI_APPLICATION = 'farm_coffee.wsgi.application'
